...
_MediaAsset _$MediaAssetFromJson(Map<String, dynamic> json) => _MediaAsset(
  ...
  shotId: nullableIdFromJson(json['shotId']),
  characterId: nullableIdFromJson(json['characterId']),
  ...
  promptId: nullableIdFromJson(json['promptId']),
  taskId: json['taskId'] as String? ?? '',
  provider: json['provider'] as String? ?? '',
  model: json['model'] as String? ?? '',
  version: (json['version'] as num?)?.toInt() ?? 1,
  parentId: nullableIdFromJson(json['parentId']),
