...
mixin _$TrackItem {
 ...
 String get id;@JsonKey(fromJson: nullableIdFromJson) String? get sourceId; String get sourceUrl; String get label; double get startAt; double get duration; double get volume; double get trim;
...
@useResult
$Res call({
 String id,@JsonKey(fromJson: nullableIdFromJson) String? sourceId, String sourceUrl, String label, double startAt, double duration, double volume, double trim
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id, @JsonKey(fromJson: nullableIdFromJson)  String? sourceId,  String sourceUrl,  String label,  double startAt,  double duration,  double volume,  double trim)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TrackItem() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id, @JsonKey(fromJson: nullableIdFromJson)  String? sourceId,  String sourceUrl,  String label,  double startAt,  double duration,  double volume,  double trim)  $default,) {final _that = this;
switch (_that) {
case _TrackItem():
return $default(_that.id,_that.sourceId,_that.sourceUrl,_that.label,_that.startAt,_that.duration,_that.volume,_that.trim);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id, @JsonKey(fromJson: nullableIdFromJson)  String? sourceId,  String sourceUrl,  String label,  double startAt,  double duration,  double volume,  double trim)?  $default,) {final _that = this;
switch (_that) {
case _TrackItem() when $default != null:
return $default(_that.id,_that.sourceId,_that.sourceUrl,_that.label,_that.startAt,_that.duration,_that.volume,_that.trim);case _:
  return null;
...
class _TrackItem implements TrackItem {
  const _TrackItem({required this.id, @JsonKey(fromJson: nullableIdFromJson) this.sourceId, this.sourceUrl = '', this.label = '', this.startAt = 0, this.duration = 0, this.volume = 1.0, this.trim = 0});
  factory _TrackItem.fromJson(Map<String, dynamic> json) => _$TrackItemFromJson(json);

@override final  String id;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? sourceId;
...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? get projectId; double get duration; List<Track> get tracks;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? projectId, double duration, List<Track> tracks
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  double duration,  List<Track> tracks)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ProjectTimeline() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  double duration,  List<Track> tracks)  $default,) {final _that = this;
switch (_that) {
case _ProjectTimeline():
return $default(_that.id,_that.projectId,_that.duration,_that.tracks);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  double duration,  List<Track> tracks)?  $default,) {final _that = this;
switch (_that) {
case _ProjectTimeline() when $default != null:
return $default(_that.id,_that.projectId,_that.duration,_that.tracks);case _:
  return null;
...
class _ProjectTimeline implements ProjectTimeline {
  const _ProjectTimeline({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId') this.projectId, this.duration = 0, final  List<Track> tracks = const []}): _tracks = tracks;
