...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson) String? episodeId,@JsonKey(fromJson: nullableIdFromJson) String? projectId, bool storyDone, bool assetsDone, bool scriptDone, bool storyboardDone, bool shotsDone, bool episodeDone, int storyPct, int assetsPct, int scriptPct, int storyboardPct, int shotsPct, int episodePct, int currentStep, String currentPhase, int overallPct
});
...
/// Create a copy of EpisodeProgress
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = freezed,Object? episodeId = freezed,Object? projectId = freezed,Object? storyDone = null,Object? assetsDone = null,Object? scriptDone = null,Object? storyboardDone = null,Object? shotsDone = null,Object? episodeDone = null,Object? storyPct = null,Object? assetsPct = null,Object? scriptPct = null,Object? storyboardPct = null,Object? shotsPct = null,Object? episodePct = null,Object? currentStep = null,Object? currentPhase = null,Object? overallPct = null,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? episodeId, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  bool storyDone,  bool assetsDone,  bool scriptDone,  bool storyboardDone,  bool shotsDone,  bool episodeDone,  int storyPct,  int assetsPct,  int scriptPct,  int storyboardPct,  int shotsPct,  int episodePct,  int currentStep,  String currentPhase,  int overallPct)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _EpisodeProgress() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? episodeId, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  bool storyDone,  bool assetsDone,  bool scriptDone,  bool storyboardDone,  bool shotsDone,  bool episodeDone,  int storyPct,  int assetsPct,  int scriptPct,  int storyboardPct,  int shotsPct,  int episodePct,  int currentStep,  String currentPhase,  int overallPct)  $default,) {final _that = this;
switch (_that) {
case _EpisodeProgress():
return $default(_that.id,_that.episodeId,_that.projectId,_that.storyDone,_that.assetsDone,_that.scriptDone,_that.storyboardDone,_that.shotsDone,_that.episodeDone,_that.storyPct,_that.assetsPct,_that.scriptPct,_that.storyboardPct,_that.shotsPct,_that.episodePct,_that.currentStep,_that.currentPhase,_that.overallPct);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? episodeId, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  bool storyDone,  bool assetsDone,  bool scriptDone,  bool storyboardDone,  bool shotsDone,  bool episodeDone,  int storyPct,  int assetsPct,  int scriptPct,  int storyboardPct,  int shotsPct,  int episodePct,  int currentStep,  String currentPhase,  int overallPct)?  $default,) {final _that = this;
switch (_that) {
case _EpisodeProgress() when $default != null:
return $default(_that.id,_that.episodeId,_that.projectId,_that.storyDone,_that.assetsDone,_that.scriptDone,_that.storyboardDone,_that.shotsDone,_that.episodeDone,_that.storyPct,_that.assetsPct,_that.scriptPct,_that.storyboardPct,_that.shotsPct,_that.episodePct,_that.currentStep,_that.currentPhase,_that.overallPct);case _:
  return null;
...
class _EpisodeProgress implements EpisodeProgress {
  const _EpisodeProgress({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson) this.episodeId, @JsonKey(fromJson: nullableIdFromJson) this.projectId, this.storyDone = false, this.assetsDone = false, this.scriptDone = false, this.storyboardDone = false, this.shotsDone = false, this.episodeDone = false, this.storyPct = 0, this.assetsPct = 0, this.scriptPct = 0, this.storyboardPct = 0, this.shotsPct = 0, this.episodePct = 0, this.currentStep = 0, this.currentPhase = 'story', this.overallPct = 0});
...
/// Create a copy of EpisodeProgress
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = freezed,Object? episodeId = freezed,Object? projectId = freezed,Object? storyDone = null,Object? assetsDone = null,Object? scriptDone = null,Object? storyboardDone = null,Object? shotsDone = null,Object? episodeDone = null,Object? storyPct = null,Object? assetsPct = null,Object? scriptPct = null,Object? storyboardPct = null,Object? shotsPct = null,Object? episodePct = null,Object? currentStep = null,Object? currentPhase = null,Object? overallPct = null,}) {
