...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? get projectId; String get name; String get description; String get negativePrompt; String get referenceImagesJson; String get thumbnailUrl; bool get isPreset; bool get isProjectDefault; DateTime? get createdAt;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? projectId, String name, String description, String negativePrompt, String referenceImagesJson, String thumbnailUrl, bool isPreset, bool isProjectDefault, DateTime? createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  String name,  String description,  String negativePrompt,  String referenceImagesJson,  String thumbnailUrl,  bool isPreset,  bool isProjectDefault,  DateTime? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Style() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  String name,  String description,  String negativePrompt,  String referenceImagesJson,  String thumbnailUrl,  bool isPreset,  bool isProjectDefault,  DateTime? createdAt)  $default,) {final _that = this;
switch (_that) {
case _Style():
return $default(_that.id,_that.projectId,_that.name,_that.description,_that.negativePrompt,_that.referenceImagesJson,_that.thumbnailUrl,_that.isPreset,_that.isProjectDefault,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  String name,  String description,  String negativePrompt,  String referenceImagesJson,  String thumbnailUrl,  bool isPreset,  bool isProjectDefault,  DateTime? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _Style() when $default != null:
return $default(_that.id,_that.projectId,_that.name,_that.description,_that.negativePrompt,_that.referenceImagesJson,_that.thumbnailUrl,_that.isPreset,_that.isProjectDefault,_that.createdAt);case _:
  return null;
...
class _Style extends Style {
  const _Style({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId') this.projectId, this.name = '', this.description = '', this.negativePrompt = '', this.referenceImagesJson = '', this.thumbnailUrl = '', this.isPreset = false, this.isProjectDefault = false, this.createdAt}): super._();
