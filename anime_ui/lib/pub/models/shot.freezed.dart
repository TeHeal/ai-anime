...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson) String? get projectId;@JsonKey(fromJson: nullableIdFromJson) String? get segmentId;@JsonKey(fromJson: nullableIdFromJson) String? get sceneId; int get sortIndex; String get prompt; String get stylePrompt; String get imageUrl; String get videoUrl; String get taskId; String get status; int get duration; String? get cameraType; String? get cameraAngle; String? get dialogue; String? get voice; String get lipSync; String? get characterName;@JsonKey(fromJson: nullableIdFromJson) String? get characterId; String? get emotion; String? get voiceName; String? get transition; String? get audioDesign; String? get priority; String? get negativePrompt; String get reviewStatus; String? get reviewComment;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson) String? projectId,@JsonKey(fromJson: nullableIdFromJson) String? segmentId,@JsonKey(fromJson: nullableIdFromJson) String? sceneId, int sortIndex, String prompt, String stylePrompt, String imageUrl, String videoUrl, String taskId, String status, int duration, String? cameraType, String? cameraAngle, String? dialogue, String? voice, String lipSync, String? characterName,@JsonKey(fromJson: nullableIdFromJson) String? characterId, String? emotion, String? voiceName, String? transition, String? audioDesign, String? priority, String? negativePrompt, String reviewStatus, String? reviewComment
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId, @JsonKey(fromJson: nullableIdFromJson)  String? segmentId, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId,  int sortIndex,  String prompt,  String stylePrompt,  String imageUrl,  String videoUrl,  String taskId,  String status,  int duration,  String? cameraType,  String? cameraAngle,  String? dialogue,  String? voice,  String lipSync,  String? characterName, @JsonKey(fromJson: nullableIdFromJson)  String? characterId,  String? emotion,  String? voiceName,  String? transition,  String? audioDesign,  String? priority,  String? negativePrompt,  String reviewStatus,  String? reviewComment)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _StoryboardShot() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId, @JsonKey(fromJson: nullableIdFromJson)  String? segmentId, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId,  int sortIndex,  String prompt,  String stylePrompt,  String imageUrl,  String videoUrl,  String taskId,  String status,  int duration,  String? cameraType,  String? cameraAngle,  String? dialogue,  String? voice,  String lipSync,  String? characterName, @JsonKey(fromJson: nullableIdFromJson)  String? characterId,  String? emotion,  String? voiceName,  String? transition,  String? audioDesign,  String? priority,  String? negativePrompt,  String reviewStatus,  String? reviewComment)  $default,) {final _that = this;
switch (_that) {
case _StoryboardShot():
return $default(_that.id,_that.projectId,_that.segmentId,_that.sceneId,_that.sortIndex,_that.prompt,_that.stylePrompt,_that.imageUrl,_that.videoUrl,_that.taskId,_that.status,_that.duration,_that.cameraType,_that.cameraAngle,_that.dialogue,_that.voice,_that.lipSync,_that.characterName,_that.characterId,_that.emotion,_that.voiceName,_that.transition,_that.audioDesign,_that.priority,_that.negativePrompt,_that.reviewStatus,_that.reviewComment);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId, @JsonKey(fromJson: nullableIdFromJson)  String? segmentId, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId,  int sortIndex,  String prompt,  String stylePrompt,  String imageUrl,  String videoUrl,  String taskId,  String status,  int duration,  String? cameraType,  String? cameraAngle,  String? dialogue,  String? voice,  String lipSync,  String? characterName, @JsonKey(fromJson: nullableIdFromJson)  String? characterId,  String? emotion,  String? voiceName,  String? transition,  String? audioDesign,  String? priority,  String? negativePrompt,  String reviewStatus,  String? reviewComment)?  $default,) {final _that = this;
switch (_that) {
case _StoryboardShot() when $default != null:
return $default(_that.id,_that.projectId,_that.segmentId,_that.sceneId,_that.sortIndex,_that.prompt,_that.stylePrompt,_that.imageUrl,_that.videoUrl,_that.taskId,_that.status,_that.duration,_that.cameraType,_that.cameraAngle,_that.dialogue,_that.voice,_that.lipSync,_that.characterName,_that.characterId,_that.emotion,_that.voiceName,_that.transition,_that.audioDesign,_that.priority,_that.negativePrompt,_that.reviewStatus,_that.reviewComment);case _:
  return null;
...
class _StoryboardShot extends StoryboardShot {
  const _StoryboardShot({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson) this.projectId, @JsonKey(fromJson: nullableIdFromJson) this.segmentId, @JsonKey(fromJson: nullableIdFromJson) this.sceneId, this.sortIndex = 0, this.prompt = '', this.stylePrompt = '', this.imageUrl = '', this.videoUrl = '', this.taskId = '', this.status = 'pending', this.duration = 5, this.cameraType, this.cameraAngle, this.dialogue, this.voice, this.lipSync = '口型同步', this.characterName, @JsonKey(fromJson: nullableIdFromJson) this.characterId, this.emotion, this.voiceName, this.transition, this.audioDesign, this.priority, this.negativePrompt, this.reviewStatus = 'pending', this.reviewComment}): super._();
...
@override@JsonKey(fromJson: nullableIdFromJson) final  String? segmentId;
