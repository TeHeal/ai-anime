...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson) String? get projectId;@JsonKey(fromJson: nullableIdFromJson) String? get userId;@JsonKey(fromJson: nullableIdFromJson) String? get episodeId;@JsonKey(fromJson: nullableIdFromJson) String? get sceneId;@JsonKey(fromJson: nullableIdFromJson) String? get shotId;@JsonKey(fromJson: nullableIdFromJson) String? get characterId;@JsonKey(fromJson: nullableIdFromJson) String? get locationId; String get type; String get subType; String get name; String get fileUrl; String get filePath; int get fileSize; String get fileHash; String get mimeType; int get width; int get height; double get duration; String get source;@JsonKey(fromJson: nullableIdFromJson) String? get promptId; String get taskId; String get provider; String get model; int get version;@JsonKey(fromJson: nullableIdFromJson) String? get parentId; String get status; String get roleIds; String get tags; DateTime? get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson) String? projectId,@JsonKey(fromJson: nullableIdFromJson) String? userId,@JsonKey(fromJson: nullableIdFromJson) String? episodeId,@JsonKey(fromJson: nullableIdFromJson) String? sceneId,@JsonKey(fromJson: nullableIdFromJson) String? shotId,@JsonKey(fromJson: nullableIdFromJson) String? characterId,@JsonKey(fromJson: nullableIdFromJson) String? locationId, String type, String subType, String name, String fileUrl, String filePath, int fileSize, String fileHash, String mimeType, int width, int height, double duration, String source,@JsonKey(fromJson: nullableIdFromJson) String? promptId, String taskId, String provider, String model, int version,@JsonKey(fromJson: nullableIdFromJson) String? parentId, String status, String roleIds, String tags, DateTime? createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId, @JsonKey(fromJson: nullableIdFromJson)  String? userId, @JsonKey(fromJson: nullableIdFromJson)  String? episodeId, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId, @JsonKey(fromJson: nullableIdFromJson)  String? shotId, @JsonKey(fromJson: nullableIdFromJson)  String? characterId, @JsonKey(fromJson: nullableIdFromJson)  String? locationId,  String type,  String subType,  String name,  String fileUrl,  String filePath,  int fileSize,  String fileHash,  String mimeType,  int width,  int height,  double duration,  String source, @JsonKey(fromJson: nullableIdFromJson)  String? promptId,  String taskId,  String provider,  String model,  int version, @JsonKey(fromJson: nullableIdFromJson)  String? parentId,  String status,  String roleIds,  String tags,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MediaAsset() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId, @JsonKey(fromJson: nullableIdFromJson)  String? userId, @JsonKey(fromJson: nullableIdFromJson)  String? episodeId, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId, @JsonKey(fromJson: nullableIdFromJson)  String? shotId, @JsonKey(fromJson: nullableIdFromJson)  String? characterId, @JsonKey(fromJson: nullableIdFromJson)  String? locationId,  String type,  String subType,  String name,  String fileUrl,  String filePath,  int fileSize,  String fileHash,  String mimeType,  int width,  int height,  double duration,  String source, @JsonKey(fromJson: nullableIdFromJson)  String? promptId,  String taskId,  String provider,  String model,  int version, @JsonKey(fromJson: nullableIdFromJson)  String? parentId,  String status,  String roleIds,  String tags,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _MediaAsset():
return $default(_that.id,_that.projectId,_that.userId,_that.episodeId,_that.sceneId,_that.shotId,_that.characterId,_that.locationId,_that.type,_that.subType,_that.name,_that.fileUrl,_that.filePath,_that.fileSize,_that.fileHash,_that.mimeType,_that.width,_that.height,_that.duration,_that.source,_that.promptId,_that.taskId,_that.provider,_that.model,_that.version,_that.parentId,_that.status,_that.roleIds,_that.tags,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId, @JsonKey(fromJson: nullableIdFromJson)  String? userId, @JsonKey(fromJson: nullableIdFromJson)  String? episodeId, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId, @JsonKey(fromJson: nullableIdFromJson)  String? shotId, @JsonKey(fromJson: nullableIdFromJson)  String? characterId, @JsonKey(fromJson: nullableIdFromJson)  String? locationId,  String type,  String subType,  String name,  String fileUrl,  String filePath,  int fileSize,  String fileHash,  String mimeType,  int width,  int height,  double duration,  String source, @JsonKey(fromJson: nullableIdFromJson)  String? promptId,  String taskId,  String provider,  String model,  int version, @JsonKey(fromJson: nullableIdFromJson)  String? parentId,  String status,  String roleIds,  String tags,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _MediaAsset() when $default != null:
return $default(_that.id,_that.projectId,_that.userId,_that.episodeId,_that.sceneId,_that.shotId,_that.characterId,_that.locationId,_that.type,_that.subType,_that.name,_that.fileUrl,_that.filePath,_that.fileSize,_that.fileHash,_that.mimeType,_that.width,_that.height,_that.duration,_that.source,_that.promptId,_that.taskId,_that.provider,_that.model,_that.version,_that.parentId,_that.status,_that.roleIds,_that.tags,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _MediaAsset extends MediaAsset {
  const _MediaAsset({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson) this.projectId, @JsonKey(fromJson: nullableIdFromJson) this.userId, @JsonKey(fromJson: nullableIdFromJson) this.episodeId, @JsonKey(fromJson: nullableIdFromJson) this.sceneId, @JsonKey(fromJson: nullableIdFromJson) this.shotId, @JsonKey(fromJson: nullableIdFromJson) this.characterId, @JsonKey(fromJson: nullableIdFromJson) this.locationId, this.type = '', this.subType = '', this.name = '', this.fileUrl = '', this.filePath = '', this.fileSize = 0, this.fileHash = '', this.mimeType = '', this.width = 0, this.height = 0, this.duration = 0.0, this.source = 'ai', @JsonKey(fromJson: nullableIdFromJson) this.promptId, this.taskId = '', this.provider = '', this.model = '', this.version = 1, @JsonKey(fromJson: nullableIdFromJson) this.parentId, this.status = 'active', this.roleIds = '', this.tags = '', this.createdAt, this.updatedAt}): super._();
...
@override@JsonKey(fromJson: nullableIdFromJson) final  String? projectId;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? userId;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? episodeId;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? sceneId;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? shotId;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? characterId;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? locationId;
...
@override@JsonKey(fromJson: nullableIdFromJson) final  String? promptId;
@override@JsonKey() final  String taskId;
@override@JsonKey() final  String provider;
@override@JsonKey() final  String model;
@override@JsonKey() final  int version;
@override@JsonKey(fromJson: nullableIdFromJson) final  String? parentId;
