...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson) String? get projectId; String get title; int get sortIndex; String get summary; String get status; int get currentStep; DateTime? get lastActiveAt; List<Scene> get scenes;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson) String? projectId, String title, int sortIndex, String summary, String status, int currentStep, DateTime? lastActiveAt, List<Scene> scenes
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  String title,  int sortIndex,  String summary,  String status,  int currentStep,  DateTime? lastActiveAt,  List<Scene> scenes)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Episode() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  String title,  int sortIndex,  String summary,  String status,  int currentStep,  DateTime? lastActiveAt,  List<Scene> scenes)  $default,) {final _that = this;
switch (_that) {
case _Episode():
return $default(_that.id,_that.projectId,_that.title,_that.sortIndex,_that.summary,_that.status,_that.currentStep,_that.lastActiveAt,_that.scenes);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  String title,  int sortIndex,  String summary,  String status,  int currentStep,  DateTime? lastActiveAt,  List<Scene> scenes)?  $default,) {final _that = this;
switch (_that) {
case _Episode() when $default != null:
return $default(_that.id,_that.projectId,_that.title,_that.sortIndex,_that.summary,_that.status,_that.currentStep,_that.lastActiveAt,_that.scenes);case _:
  return null;
...
class _Episode implements Episode {
  const _Episode({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson) this.projectId, this.title = '', this.sortIndex = 0, this.summary = '', this.status = 'not_started', this.currentStep = 0, this.lastActiveAt, final  List<Scene> scenes = const []}): _scenes = scenes;
