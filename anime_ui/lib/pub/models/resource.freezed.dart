...
@JsonKey(fromJson: _resourceIdFromJson) String? get id;@JsonKey(fromJson: _resourceIdFromJson) String? get userId; String get name; String get libraryType; String get modality; String get thumbnailUrl; String get tagsJson; String get version; String get metadataJson; String get bindingIdsJson; String get description; DateTime? get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
@JsonKey(fromJson: _resourceIdFromJson) String? id,@JsonKey(fromJson: _resourceIdFromJson) String? userId, String name, String libraryType, String modality, String thumbnailUrl, String tagsJson, String version, String metadataJson, String bindingIdsJson, String description, DateTime? createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _resourceIdFromJson)  String? id, @JsonKey(fromJson: _resourceIdFromJson)  String? userId,  String name,  String libraryType,  String modality,  String thumbnailUrl,  String tagsJson,  String version,  String metadataJson,  String bindingIdsJson,  String description,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Resource() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: _resourceIdFromJson)  String? id, @JsonKey(fromJson: _resourceIdFromJson)  String? userId,  String name,  String libraryType,  String modality,  String thumbnailUrl,  String tagsJson,  String version,  String metadataJson,  String bindingIdsJson,  String description,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _Resource():
return $default(_that.id,_that.userId,_that.name,_that.libraryType,_that.modality,_that.thumbnailUrl,_that.tagsJson,_that.version,_that.metadataJson,_that.bindingIdsJson,_that.description,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: _resourceIdFromJson)  String? id, @JsonKey(fromJson: _resourceIdFromJson)  String? userId,  String name,  String libraryType,  String modality,  String thumbnailUrl,  String tagsJson,  String version,  String metadataJson,  String bindingIdsJson,  String description,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _Resource() when $default != null:
return $default(_that.id,_that.userId,_that.name,_that.libraryType,_that.modality,_that.thumbnailUrl,_that.tagsJson,_that.version,_that.metadataJson,_that.bindingIdsJson,_that.description,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _Resource extends Resource {
  const _Resource({@JsonKey(fromJson: _resourceIdFromJson) this.id, @JsonKey(fromJson: _resourceIdFromJson) this.userId, this.name = '', this.libraryType = '', this.modality = '', this.thumbnailUrl = '', this.tagsJson = '', this.version = '', this.metadataJson = '', this.bindingIdsJson = '', this.description = '', this.createdAt, this.updatedAt}): super._();
  factory _Resource.fromJson(Map<String, dynamic> json) => _$ResourceFromJson(json);

@override@JsonKey(fromJson: _resourceIdFromJson) final  String? id;
@override@JsonKey(fromJson: _resourceIdFromJson) final  String? userId;
