...
class LocationToolbar extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<LocationToolbar> createState() => _LocationToolbarState();
}

class _LocationToolbarState extends ConsumerState<LocationToolbar> {
  final _searchCtrl = TextEditingController();

  @override
  void initState() {
    super.initState();
    _searchCtrl.text = ref.read(locNameSearchProvider);
  }
  ...
  Widget build(BuildContext context) {
    ...
    final searchState = ref.watch(locNameSearchProvider);
      ...
      child: Row(
        children: [
          AppSearchField(
            ...
            height: 34,
            onChanged: (v) =>
                ref.read(locNameSearchProvider.notifier).set(v),
          ),
            ...
            child: Wrap(
              ...
              children: [
                ...
                if (hasFilter)
                  TextButton(
                    onPressed: () {
                      ref.read(locStatusFilterProvider.notifier).set(null);
                      ref.read(locNameSearchProvider.notifier).set('');
                    },
                    child: Text(
                      '重置',
