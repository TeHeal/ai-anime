...
// Impact 解冻影响分析：返回下游引用当前版本资产的内容（脚本、镜图、镜头等）
// 当前为桩实现，返回空列表；后续可接入 script/shot_image/shot_video 等模块的引用分析
func (s *Service) Impact(ctx context.Context, projectID string) ([]ImpactItem, error) {
	// TODO: 分析脚本、镜图、镜头中对角色/场景/道具的引用
	return nil, nil
}
