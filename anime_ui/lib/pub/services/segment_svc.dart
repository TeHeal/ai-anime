...
class SegmentService {
  Future<ScriptSegment> create(String projectId, {required String content, int sortIndex = 0}) async {
  ...
  Future<List<ScriptSegment>> bulkCreate(String projectId, List<ScriptSegment> segments) async {
  ...
  Future<List<ScriptSegment>> list(String projectId) async {
    final resp = await dio.get('/projects/$projectId/segments');
    return extractDataList(resp, ScriptSegment.fromJson);
  }

  Future<ScriptSegment> update(String projectId, String segId, {String? content, int? sortIndex}) async {
  ...
  Future<void> delete(String projectId, String segId) async {
