...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? get projectId; int get sortIndex; String get content;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? projectId, int sortIndex, String content
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  int sortIndex,  String content)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ScriptSegment() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  int sortIndex,  String content)  $default,) {final _that = this;
switch (_that) {
case _ScriptSegment():
return $default(_that.id,_that.projectId,_that.sortIndex,_that.content);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  int sortIndex,  String content)?  $default,) {final _that = this;
switch (_that) {
case _ScriptSegment() when $default != null:
return $default(_that.id,_that.projectId,_that.sortIndex,_that.content);case _:
  return null;
...
class _ScriptSegment implements ScriptSegment {
  const _ScriptSegment({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId') this.projectId, this.sortIndex = 0, this.content = ''});
