...
/// 音色生成弹窗底部操作栏
class VoiceGenFooter extends StatelessWidget {
  const VoiceGenFooter({
    super.key,
    required this.ctrl,
    ...
    return Container(
      ...
      child: Row(
        children: [
          ...
          FilledButton.icon(
            onPressed: ctrl.canGenerate ? onGenerate : null,
            icon: Icon(
            ...
            style: FilledButton.styleFrom(
              backgroundColor: ctrl.canGenerate
                  ? accent
                  : AppColors.surfaceContainer,
              foregroundColor: ctrl.canGenerate
                  ? AppColors.onPrimary
