...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? get projectId; String get format; String get resolution; String get status; String get outputUrl; int get fileSize; String get taskId; String? get error; int get progress;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? projectId, String format, String resolution, String status, String outputUrl, int fileSize, String taskId, String? error, int progress
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  String format,  String resolution,  String status,  String outputUrl,  int fileSize,  String taskId,  String? error,  int progress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ExportRecord() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  String format,  String resolution,  String status,  String outputUrl,  int fileSize,  String taskId,  String? error,  int progress)  $default,) {final _that = this;
switch (_that) {
case _ExportRecord():
return $default(_that.id,_that.projectId,_that.format,_that.resolution,_that.status,_that.outputUrl,_that.fileSize,_that.taskId,_that.error,_that.progress);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId,  String format,  String resolution,  String status,  String outputUrl,  int fileSize,  String taskId,  String? error,  int progress)?  $default,) {final _that = this;
switch (_that) {
case _ExportRecord() when $default != null:
return $default(_that.id,_that.projectId,_that.format,_that.resolution,_that.status,_that.outputUrl,_that.fileSize,_that.taskId,_that.error,_that.progress);case _:
  return null;
...
class _ExportRecord extends ExportRecord {
  const _ExportRecord({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId') this.projectId, this.format = 'mp4', this.resolution = '1080p', this.status = 'pending', this.outputUrl = '', this.fileSize = 0, this.taskId = '', this.error, this.progress = 0}): super._();
