...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson) String? get projectId; String get type; String get name; String get desc; String get imageUrl; String get tags; bool get shared;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson) String? projectId, String type, String name, String desc, String imageUrl, String tags, bool shared
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  String type,  String name,  String desc,  String imageUrl,  String tags,  bool shared)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Asset() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  String type,  String name,  String desc,  String imageUrl,  String tags,  bool shared)  $default,) {final _that = this;
switch (_that) {
case _Asset():
return $default(_that.id,_that.projectId,_that.type,_that.name,_that.desc,_that.imageUrl,_that.tags,_that.shared);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  String type,  String name,  String desc,  String imageUrl,  String tags,  bool shared)?  $default,) {final _that = this;
switch (_that) {
case _Asset() when $default != null:
return $default(_that.id,_that.projectId,_that.type,_that.name,_that.desc,_that.imageUrl,_that.tags,_that.shared);case _:
  return null;
...
class _Asset extends Asset {
  const _Asset({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson) this.projectId, this.type = 'scene', this.name = '', this.desc = '', this.imageUrl = '', this.tags = '', this.shared = false}): super._();
