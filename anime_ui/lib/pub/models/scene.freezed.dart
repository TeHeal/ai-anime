...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson, name: 'episodeId') String? get episodeId; String get sceneId; String get location; String get time; String get interiorExterior; List<String> get characters; int get sortIndex; List<SceneBlock> get blocks;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson, name: 'episodeId') String? episodeId, String sceneId, String location, String time, String interiorExterior, List<String> characters, int sortIndex, List<SceneBlock> blocks
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'episodeId')  String? episodeId,  String sceneId,  String location,  String time,  String interiorExterior,  List<String> characters,  int sortIndex,  List<SceneBlock> blocks)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Scene() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'episodeId')  String? episodeId,  String sceneId,  String location,  String time,  String interiorExterior,  List<String> characters,  int sortIndex,  List<SceneBlock> blocks)  $default,) {final _that = this;
switch (_that) {
case _Scene():
return $default(_that.id,_that.episodeId,_that.sceneId,_that.location,_that.time,_that.interiorExterior,_that.characters,_that.sortIndex,_that.blocks);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'episodeId')  String? episodeId,  String sceneId,  String location,  String time,  String interiorExterior,  List<String> characters,  int sortIndex,  List<SceneBlock> blocks)?  $default,) {final _that = this;
switch (_that) {
case _Scene() when $default != null:
return $default(_that.id,_that.episodeId,_that.sceneId,_that.location,_that.time,_that.interiorExterior,_that.characters,_that.sortIndex,_that.blocks);case _:
  return null;
...
class _Scene implements Scene {
  const _Scene({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson, name: 'episodeId') this.episodeId, this.sceneId = '', this.location = '', this.time = '', this.interiorExterior = '', final  List<String> characters = const [], this.sortIndex = 0, final  List<SceneBlock> blocks = const []}): _characters = characters,_blocks = blocks;
