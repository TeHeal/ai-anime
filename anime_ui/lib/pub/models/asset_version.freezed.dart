...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson) String? get projectId; int get version; String get action; String get statsJson; String get deltaJson; String get note; DateTime? get createdAt; DateTime? get updatedAt;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson) String? projectId, int version, String action, String statsJson, String deltaJson, String note, DateTime? createdAt, DateTime? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  int version,  String action,  String statsJson,  String deltaJson,  String note,  DateTime? createdAt,  DateTime? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _AssetVersion() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  int version,  String action,  String statsJson,  String deltaJson,  String note,  DateTime? createdAt,  DateTime? updatedAt)  $default,) {final _that = this;
switch (_that) {
case _AssetVersion():
return $default(_that.id,_that.projectId,_that.version,_that.action,_that.statsJson,_that.deltaJson,_that.note,_that.createdAt,_that.updatedAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? projectId,  int version,  String action,  String statsJson,  String deltaJson,  String note,  DateTime? createdAt,  DateTime? updatedAt)?  $default,) {final _that = this;
switch (_that) {
case _AssetVersion() when $default != null:
return $default(_that.id,_that.projectId,_that.version,_that.action,_that.statsJson,_that.deltaJson,_that.note,_that.createdAt,_that.updatedAt);case _:
  return null;
...
class _AssetVersion extends AssetVersion {
  const _AssetVersion({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson) this.projectId, this.version = 0, this.action = '', this.statsJson = '', this.deltaJson = '', this.note = '', this.createdAt, this.updatedAt}): super._();
