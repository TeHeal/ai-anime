...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson) String? get sceneId; String get type; String get character; String get emotion; String get content; int get sortIndex;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson) String? sceneId, String type, String character, String emotion, String content, int sortIndex
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId,  String type,  String character,  String emotion,  String content,  int sortIndex)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _SceneBlock() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId,  String type,  String character,  String emotion,  String content,  int sortIndex)  $default,) {final _that = this;
switch (_that) {
case _SceneBlock():
return $default(_that.id,_that.sceneId,_that.type,_that.character,_that.emotion,_that.content,_that.sortIndex);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson)  String? sceneId,  String type,  String character,  String emotion,  String content,  int sortIndex)?  $default,) {final _that = this;
switch (_that) {
case _SceneBlock() when $default != null:
return $default(_that.id,_that.sceneId,_that.type,_that.character,_that.emotion,_that.content,_that.sortIndex);case _:
  return null;
...
class _SceneBlock implements SceneBlock {
  const _SceneBlock({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson) this.sceneId, this.type = 'action', this.character = '', this.emotion = '', this.content = '', this.sortIndex = 0});
