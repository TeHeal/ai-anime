...
@JsonKey(fromJson: nullableIdFromJson) String? get id; String get title; int get sortIndex; String get summary; String get status; int get currentStep; String get currentPhase; int get sceneCount; List<String> get characterNames; DateTime? get lastActiveAt; DateTime? get createdAt; EpisodeProgress? get progress;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id, String title, int sortIndex, String summary, String status, int currentStep, String currentPhase, int sceneCount, List<String> characterNames, DateTime? lastActiveAt, DateTime? createdAt, EpisodeProgress? progress
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id,  String title,  int sortIndex,  String summary,  String status,  int currentStep,  String currentPhase,  int sceneCount,  List<String> characterNames,  DateTime? lastActiveAt,  DateTime? createdAt,  EpisodeProgress? progress)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardEpisode() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id,  String title,  int sortIndex,  String summary,  String status,  int currentStep,  String currentPhase,  int sceneCount,  List<String> characterNames,  DateTime? lastActiveAt,  DateTime? createdAt,  EpisodeProgress? progress)  $default,) {final _that = this;
switch (_that) {
case _DashboardEpisode():
return $default(_that.id,_that.title,_that.sortIndex,_that.summary,_that.status,_that.currentStep,_that.currentPhase,_that.sceneCount,_that.characterNames,_that.lastActiveAt,_that.createdAt,_that.progress);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id,  String title,  int sortIndex,  String summary,  String status,  int currentStep,  String currentPhase,  int sceneCount,  List<String> characterNames,  DateTime? lastActiveAt,  DateTime? createdAt,  EpisodeProgress? progress)?  $default,) {final _that = this;
switch (_that) {
case _DashboardEpisode() when $default != null:
return $default(_that.id,_that.title,_that.sortIndex,_that.summary,_that.status,_that.currentStep,_that.currentPhase,_that.sceneCount,_that.characterNames,_that.lastActiveAt,_that.createdAt,_that.progress);case _:
  return null;
...
class _DashboardEpisode implements DashboardEpisode {
  const _DashboardEpisode({@JsonKey(fromJson: nullableIdFromJson) this.id, this.title = '', this.sortIndex = 0, this.summary = '', this.status = 'not_started', this.currentStep = 0, this.currentPhase = 'story', this.sceneCount = 0, final  List<String> characterNames = const [], this.lastActiveAt, this.createdAt, this.progress}): _characterNames = characterNames;
