...
@JsonKey(fromJson: nullableIdFromJson) String? get id;@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? get projectId;@JsonKey(fromJson: nullableIdFromJson, name: 'shotId') String? get shotId; String get text; String get voiceId; String get voiceName; String get emotion; String get provider; String get model; String get audioUrl; double get duration; String get status; String get taskId;
...
@useResult
$Res call({
@JsonKey(fromJson: nullableIdFromJson) String? id,@JsonKey(fromJson: nullableIdFromJson, name: 'projectId') String? projectId,@JsonKey(fromJson: nullableIdFromJson, name: 'shotId') String? shotId, String text, String voiceId, String voiceName, String emotion, String provider, String model, String audioUrl, double duration, String status, String taskId
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId, @JsonKey(fromJson: nullableIdFromJson, name: 'shotId')  String? shotId,  String text,  String voiceId,  String voiceName,  String emotion,  String provider,  String model,  String audioUrl,  double duration,  String status,  String taskId)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Voiceover() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId, @JsonKey(fromJson: nullableIdFromJson, name: 'shotId')  String? shotId,  String text,  String voiceId,  String voiceName,  String emotion,  String provider,  String model,  String audioUrl,  double duration,  String status,  String taskId)  $default,) {final _that = this;
switch (_that) {
case _Voiceover():
return $default(_that.id,_that.projectId,_that.shotId,_that.text,_that.voiceId,_that.voiceName,_that.emotion,_that.provider,_that.model,_that.audioUrl,_that.duration,_that.status,_that.taskId);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function(@JsonKey(fromJson: nullableIdFromJson)  String? id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId')  String? projectId, @JsonKey(fromJson: nullableIdFromJson, name: 'shotId')  String? shotId,  String text,  String voiceId,  String voiceName,  String emotion,  String provider,  String model,  String audioUrl,  double duration,  String status,  String taskId)?  $default,) {final _that = this;
switch (_that) {
case _Voiceover() when $default != null:
return $default(_that.id,_that.projectId,_that.shotId,_that.text,_that.voiceId,_that.voiceName,_that.emotion,_that.provider,_that.model,_that.audioUrl,_that.duration,_that.status,_that.taskId);case _:
  return null;
...
class _Voiceover extends Voiceover {
  const _Voiceover({@JsonKey(fromJson: nullableIdFromJson) this.id, @JsonKey(fromJson: nullableIdFromJson, name: 'projectId') this.projectId, @JsonKey(fromJson: nullableIdFromJson, name: 'shotId') this.shotId, this.text = '', this.voiceId = '', this.voiceName = '', this.emotion = '', this.provider = '', this.model = '', this.audioUrl = '', this.duration = 0, this.status = 'pending', this.taskId = ''}): super._();
