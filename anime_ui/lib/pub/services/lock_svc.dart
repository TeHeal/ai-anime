...
class LockService {
  Future<LockStatus> lock(String projectId, String phase) async {
    final resp = await dio.post('/projects/$projectId/lock/$phase');
    return extractDataObject(resp, LockStatus.fromJson);
  }

  Future<LockStatus> unlock(String projectId, String phase) async {
    final resp = await dio.delete('/projects/$projectId/lock/$phase');
    return extractDataObject(resp, LockStatus.fromJson);
  }

  Future<LockStatus> getStatus(String projectId) async {
